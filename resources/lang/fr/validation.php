...
return [
    ...
    | ont plusieurs versions telles que les règles de taille. N'hésitez pas
    | à modifier chaque message ici.
    |
    */
    ...
    'alpha_dash' => 'Le :attribute ne doit contenir que des lettres, chiffres, tirets et underscores.',
    ...
    | lignes. Cela permet de spécifier rapidement un message personnalisé
