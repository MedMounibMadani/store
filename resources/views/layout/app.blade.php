...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>SAII - Achetez des Panneaux Solaires de Qualité</title>
        <meta name="description" content="Découvrez notre gamme de panneaux solaires de haute qualité. Économisez sur vos factures d'électricité avec nos solutions écologiques et durables.">
